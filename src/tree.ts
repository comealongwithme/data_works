            ...
            Children: [
                {
                    ...
                    Children: [{ VerticalSpan: 1, Color: "Orange", Value: "7", Children: [] }],
                },
                {
                    VerticalSpan: 1, Color: "Orange", Value: "5",
                    Children: [{ VerticalSpan: 1, Color: "Orange", Value: "8", Children: [] }],
                },
            ],
        },
        {
            VerticalSpan: 1, Color: "Green", Value: "2",
            Children: [{ VerticalSpan: 2, Color: "Green", Value: "6", Children: [] }],
        },
        {
            VerticalSpan: 2, Color: "Purple", Value: "3",
            Children: [
